...
#define CONFIG_SENSORS_BMA150_POSITION_V2 7
/* for debugging */
#define DEBUG 0
...
static int bma150_device_ioctl(struct file*, unsigned int, unsigned long );
...
static struct file_operations bma150_device_fops =
{
	...
	.unlocked_ioctl = bma150_device_ioctl,
...
static int bma150_device_ioctl(struct file* file, unsigned int cmd, unsigned long arg)
{
